...
To Add the Prerequisites Kali OS - Addon - Download this small Package and Extract it to ~/Freetz-NG<br>

<a href=https://github.com/Systemx23x/FRITZ-Box_7490_freetz-ng/releases/download/Addon/Freetz-NG_add_prerequisites_Kali_install.zip>Addon - add Kali-OS Preq. Install</a><br>
